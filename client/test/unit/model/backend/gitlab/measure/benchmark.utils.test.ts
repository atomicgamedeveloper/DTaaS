...
describe('benchmark.utils', () => {
  ...
  describe('areAllBenchmarksComplete', () => {
    it('should return false for empty array', () => {
      expect(areAllBenchmarksComplete([])).toBe(false);
    });
    ...
    it('should return false if any task has STOPPED status', () => {
      ...
      expect(areAllBenchmarksComplete(tasks)).toBe(false);
    });
    ...
    it('should return true when all tasks are SUCCESS', () => {
      ...
      expect(areAllBenchmarksComplete(tasks)).toBe(true);
    });
  ...
  describe('getBenchmarkStatus', () => {
    it('should return hasStarted false when all tasks are NOT_STARTED', () => {
      ...
      const status = getBenchmarkStatus(results);
