/**
 * Pure types for the benchmark module. No runtime state or side effects.
 *
 * Used by benchmark.execution.ts, benchmark.settings.ts, and most other
